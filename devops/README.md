...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trepr-shogunbr.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for trepr-shogunbr.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    trepr-shogunbr.tangrama.com.br:
      ansible_user: root
      host: trepr-shogunbr
      hostname: trepr-shogunbr.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trepr-shogunbr.tangrama.com.br.yml` to the remote server with:
